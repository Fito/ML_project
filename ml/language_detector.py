...
x_train, x_test, y_train, y_test = train_test_split(docs, target, test_size=.2, random_state=0)
...
vectorizer = TfidfVectorizer(ngram_range=(1,5), analyzer='char', use_idf=True)
